...
public class category_menu {
		...
		if (s.trim().equals("$")) {
			...
			try {
				...
				if (bl.isCategoryExistById(id)) {
					System.out.println("the category id is exict.\n");
					run();
				} else {
					...
					if (s.trim().equals("$")) {
						...
						System.out.println(
								"insert Category top category if exist \n If you wish to return to the update menu press $\n");
						s = in.nextLine();
						while (!s.trim().equals("$") && !this.check.checkOnlyNumbers(s) && !bl.isCategoryExistById(Integer.parseInt(s))) {
							System.out.println("Illegal input, please try again.");
							s = in.nextLine();
						}
						if (s.trim().equals("$")) {
							...
							System.out.println(
									"insert Category discount if exist\n"
									+ " if not exist press % \n"
									+ " If you wish to return to the update menu press $\n");
							while (!s.equals("$") && !s.equals("%") && !this.check.checkOnlyNumbers(s)) {
								System.out.println("Illegal input, please try again.");
								s = in.nextLine();
							}
							if (s.trim().equals("$")) {
								...
								if (!s.equals("%")) {
									...
									System.out.println("insert Category discount begin date if exist \n");
									s = in.nextLine();
									while (check.checkDate(s) || s.equals("")) {
										System.out.println("Illegal input, please try again.");
										s = in.nextLine();
									}
									cat.setStartDiscountDate(s);
									System.out.println("insert Category discount end date if exist \n");
									s = in.nextLine();
									while (check.checkDate(s) || s.equals("")) {
										System.out.println("Illegal input, please try again.");
										s = in.nextLine();
									}
									cat.setEndDiscountDate(s);
								}
	...
	public void updateCategory(){
		System.out.println("Please enter the category ID you wish to edit.\nIf you wish to return to category manager menu press $");
		String s=in.nextLine();
		...
		System.out.println("Category update menu:\n"
				...
				+"6. Back to category main menu.");
		s=in.nextLine();
		while(!this.check.check_number_range(s, 1, 6) && !(s.equals("$")))
		{
		...
		if(s.equals("$")){
			...
			case("2"):{
				System.out.println("Enter the new Top ID category.\nTo go back to category manager menu press '$'\n");
				s=in.nextLine();
				while(!this.check.checkOnlyNumbers(s) && !(s.equals("$")))
				{
					System.out.println("wrong input, please try again.\nTo go back to category manager menu press '$'.\n");
			...
			case("3"):{
				...
				if(s.equals("$")){
					...
					cat.setDiscount(Integer.parseInt(s));
				break;
			}
			case("4"):{
				System.out.println("Enter discount start day.\nTo go back to category manager menu press '$'\n");
				s=in.nextLine();
				while(!this.check.checkDate(s) && !(s.equals("$")))
				{
					System.out.println("wrong input, please try again.\nTo go back to category manager menu press '$'.\n");
					s=in.nextLine();
				}
			...
			case("5"):{
				System.out.println("Enter discount end day.\nTo go back to category manager menu press '$'\n");
				s=in.nextLine();
				while(!this.check.checkDate(s) && !(s.equals("$")))
				{
					System.out.println("wrong input, please try again.\nTo go back to category manager menu press '$'.\n");
	...
	public void DeleteCategory(){
		System.out.println("Please enter the category ID you wish to delete.\nIf you wish to return to category manager menu press $");
		String s=in.nextLine();
		while(!this.check.checkOnlyNumbers(s) && !(s.equals("$")))
		{
			System.out.println("This category does not exists, please enter category name again.\nTo go back to category manager menu press '$'.");
