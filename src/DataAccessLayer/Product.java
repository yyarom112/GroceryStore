...
public class Product {
	...
	private double discountInBuyPrice;
	private int sellPrice;
	private double discpountSellPrice;
	private String startDateDiscountSellPrice;
	private String endDateDiscountSellPrice;
	...
	public Product(int barcodeProduct) {
		...
		this.buyPrice = 0;
		this.discountInBuyPrice = 0;
		this.sellPrice = 0;
		this.discpountSellPrice = 0;
	...
	public Product(int barcodeProduct, String productName, int deliveryTime, int storeQuantity, int storeroomQuantity,
			...
			int faultyProductInStore, int faultyProductInStoreroom, int buyPrice, double discountInBuyPrice,
			int sellPrice, double discpountSellPrice, String startDateDiscountSellPrice, String endDateDiscountSellPrice,
			int categoryID) {
		this.barcodeProduct = barcodeProduct;
		...
		this.discountInBuyPrice = discountInBuyPrice;
		this.sellPrice = sellPrice;
		this.discpountSellPrice = discpountSellPrice;
		this.startDateDiscountSellPrice = startDateDiscountSellPrice;
		this.endDateDiscountSellPrice = endDateDiscountSellPrice;
	...
	public double getDiscountInBuyPrice() {
		return discountInBuyPrice;
	}

	public void setDiscountInBuyPrice(double discountInBuyPrice) {
		this.discountInBuyPrice = discountInBuyPrice;
	}
	...
	public double getDiscpountSellPrice() {
		return discpountSellPrice;
	}

	public void setDiscpountSellPrice(double discpountSellPrice) {
		this.discpountSellPrice = discpountSellPrice;
	}

	public String getStartDateDiscountSellPrice() {
		return startDateDiscountSellPrice;
	}

	public void setStartDateDiscountSellPrice(String startDateDiscountSellPrice) {
		this.startDateDiscountSellPrice = startDateDiscountSellPrice;
	}

	public String getEndDateDiscountSellPrice() {
		return endDateDiscountSellPrice;
	}

	public void setEndDateDiscountSellPrice(String endDateDiscountSellPrice) {
		this.endDateDiscountSellPrice = endDateDiscountSellPrice;
	}
